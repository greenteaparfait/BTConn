...
package com.ebookfrenzy.btconn.http;

import android.os.AsyncTask;

import com.ebookfrenzy.btconn.utils.Logs;

import java.io.IOException;
import java.net.MalformedURLException;
import java.net.URL;

import static com.ebookfrenzy.btconn.http.HttpInterface.MSG_HTTP_RESULT_CODE_OK;
import static com.ebookfrenzy.btconn.http.HttpInterface.REQUEST_TYPE_GET;


public class HttpAsyncTask extends AsyncTask<Void, Integer, String> implements com.ebookfrenzy.btconn.http.HttpInterface
{
	// Global variables
...
//	private Map<String, String> mMap;	// Disabled
	...
	// Context, system
	private com.ebookfrenzy.btconn.http.HttpListener mListener;
	
	// Constructor
	public HttpAsyncTask(com.ebookfrenzy.btconn.http.HttpListener listener, int type, String url, int requestType) {
		mListener = listener;
	...
	protected String doInBackground(Void... unused) 
	{
		...
		com.ebookfrenzy.btconn.http.HttpRequester httpRequester = new com.ebookfrenzy.btconn.http.HttpRequester();
