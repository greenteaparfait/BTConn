...
package com.ebookfrenzy.btconn.fragments;
...
import com.ebookfrenzy.btconn.R;
...
public class FragmentAdapter extends FragmentPagerAdapter {
    ...
    private com.ebookfrenzy.btconn.fragments.IFragmentListener mFragmentListener = null;
    
    private Fragment mExampleFragment = null;
    private Fragment mLLSettingsFragment = null;
    
    public FragmentAdapter(FragmentManager fm, Context c, com.ebookfrenzy.btconn.fragments.IFragmentListener l, Handler h) {
		super(fm);
		mContext = c;
		mFragmentListener = l;
		mHandler = h;
