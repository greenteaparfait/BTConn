...
package com.ebookfrenzy.btconn.utils;
...
public class AppSettings {
	...
	public static void setSettingsValue(int type, boolean boolValue, int intValue, String stringValue) {
		...
		SharedPreferences prefs = mContext.getSharedPreferences(com.ebookfrenzy.btconn.utils.Constants.PREFERENCE_NAME, Context.MODE_PRIVATE);
		SharedPreferences.Editor editor = prefs.edit();
		switch(type) {
		case SETTINGS_BACKGROUND_SERVICE:
			editor.putBoolean(com.ebookfrenzy.btconn.utils.Constants.PREFERENCE_KEY_BG_SERVICE, boolValue);
			editor.commit();
	...
	public static boolean loadBgService() {
		SharedPreferences prefs = mContext.getSharedPreferences(com.ebookfrenzy.btconn.utils.Constants.PREFERENCE_NAME, Context.MODE_PRIVATE);
		boolean isTrue = prefs.getBoolean(com.ebookfrenzy.btconn.utils.Constants.PREFERENCE_KEY_BG_SERVICE, false);
		return isTrue;
	}
